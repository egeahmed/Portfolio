...
namespace APIs
{
    public static class DatabaseAPI
    {
        ...
        public static void InitializeDatabase() => reference = FirebaseDatabase.GetInstance("https://sgpk-6eb69-default-rtdb.europe-west1.firebasedatabase.app/").RootReference;
